...
<!--
![](img/win/win-img-75.png)
-->

![](img/win/win-img-75.png)
![](img/win/win-img-76.png)

You can follow the default instructions as shown below: 

![](img/win/win-img-77.png)
![](img/win/win-img-78.png)
...
```{r, echo=FALSE}
if (file.exists("git-example")) unlink(
    "git-example", recursive = TRUE,
    force = TRUE
)
```
...
![](/Users/rshear/Projects/dsbook-part-1/img/git/git-add.png)
...
![](/Users/rshear/Projects/dsbook-part-1/img//git/git-commit.png)
...
![](img/win/win-img-112.png)
![](img/win/win-img-113.png)
...
![](img/win/win-img-86.png)
![](img/win/win-img-87.png)
...
![](img/win/win-img-88.png)
![](img/win/win-img-89.png)
...
![](img/win/win-img-93.png)
![](img/win/win-img-94.png)

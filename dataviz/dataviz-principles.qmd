...
```{r piechart,  echo=FALSE, cache=FALSE}
library(ggthemes)
...
```{r excel-barplot, warning = FALSE, message=FALSE, echo=FALSE, cache=FALSE}
library(scales)
...
<!-- ttp://paldhous.github.io/ucb/2016/img/class2_8.jpg -->
![](img/class2_8.jpg)
...
```{r scatter-plot-instead-of-slope, echo=FALSE, cache=FALSE}
library(ggrepel)
west <- c("Western Europe","Northern Europe","Southern Europe",
          "Northern America","Australia and New Zealand")
...
```{r r-color-brewer-seq, fig.height=3.5, echo=FALSE, cache=FALSE}
library(RColorBrewer)
rafalib::mypar()
display.brewer.all(type="seq")
```
...
```{r measels-exercise, fig.height = 5, echo=FALSE, cache=FALSE}
library(gridExtra)
...
```{r pseudo-3d-exercise, fig.width=7, fig.height = 3.708,  echo=FALSE, cache=FALSE}

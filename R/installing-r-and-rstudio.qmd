...
![](img/win/win-img-6.png)

Select the default even when you get an ominous warning.

![](img/win/win-img-7.png)

When selecting the language, consider that it will be easier to follow this book if you select English.

![](img/win/win-img-8.png)

Continue to select all the defaults:

![](img/win/win-img-9.png)
![](img/win/win-img-10.png)
![](img/win/win-img-11.png)
![](img/win/win-img-12.png)

![](img/win/win-img-13.png)
![](img/win/win-img-14.png)
![](img/win/win-img-15.png)
...
![](img/win/win-img-29.png)

On the Mac, it will be in the Applications folder:

![](img/mac/mac-img-31.png)
![](img/mac/mac-img-32.png)
